    ...
    <div class="col10">
        <div class="card">
            <div class="card-header">Tambah Data Soal
                <a class="btn btn-sm btn-info float-right" href="{{url('data-soal')}}"><i class="fas fa-backward"></i>Kembali</a>
            </div>
            <div class="card-body">
                <form action="{{url('simpan-soal')}}" method="POST">
                    @csrf
                    ...
                    <a class="btn btn-warning float-right" href="{{url('data-soal')}}"><i class="fas fa-backward"></i>Batal</a>
